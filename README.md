...
## Creating an installable text editor app to use online and offline.

This is an application creating an installable text editor app to use online and offline and deployed using Heroku.
